...
class TrackedTable(Component):
    ...
    tracked1_used_up_xpath = '//*[@id="trackablesTable"]/tbody/tr/td[4]/plus-minus/div[1]/div/button[1]'
    tracked1_used_down_xpath = '//*[@id="trackablesTable"]/tbody/tr/td[4]/plus-minus/div[1]/div/button[2]'
