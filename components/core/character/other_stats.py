...
class OtherStats(Component):
    ...
    edit_btn_xpath = '//*[@id="stats"]/div[4]/div[2]/div/div/div/div/other-stats/preview-edit/div[1]/div/span'
    save_btn_xpath = '//*[@id="stats"]/div[4]/div[2]/div/div/div/div/other-stats/preview-edit/div[1]/button[1]'

    # View labels and popovers

    ac_label_xpath = '//*[@id="stats"]/div[4]/div[2]/div/div/div/div/other-stats/preview-edit/div[2]/div[2]/div'
    ac_popover_icon_xpath = '//*[@id="otherStatsAcPopoverIconSpan"]'
    ac_popover_content_xpath = '//*[contains(@id, "popover")]/div[2]'

    initiative_label_xpath = '//*[@id="stats"]/div[4]/div[2]/div/div/div/div/other-stats/preview-edit/div[3]/div[1]/div'
    initiative_popover_icon_xpath = '//*[@id="otherStatsInitiativePopoverIconSpan"]'
    initiative_popover_content_xpath = '//*[contains(@id, "popover")]/div[2]'

    proficiency_bonus_label_xpath = '//*[@id="stats"]/div[4]/div[2]/div/div/div/div/other-stats/preview-edit/div[2]/div[1]/div'
    proficiency_popover_icon_xpath = '//*[@id="otherStatsProficiencyPopoverIconSpan"]'
    proficiency_popover_content_xpath = '//*[contains(@id, "popover")]/div[2]'

    speed_label_xpath = '//*[@id="stats"]/div[4]/div[2]/div/div/div/div/other-stats/preview-edit/div[3]/div[2]/div'
    level_label_xpath = '//*[@id="stats"]/div[4]/div[2]/div/div/div/div/other-stats/preview-edit/div[4]/div[1]/div'
    experience_label_xpath = '//*[@id="stats"]/div[4]/div[2]/div/div/div/div/other-stats/preview-edit/div[4]/div[2]/div'

    # Edit inputs

    proficiency_bonus_input_xpath = '//*[@id="otherStatsProficiencyBonusModifierInput"]'
    ac_modifier_input_xpath = '//*[@id="otherStatsAcModifierInput"]'
    initiative_modifier_input_xpath = '//*[@id="otherStatsInitiativeModiferInput"]'
    ...
    inspiration_input_xpath = '//*[@id="stats"]/div[4]/div[2]/div/div/div/div/other-stats/preview-edit/div[2]/form/div/div[4]/div/div/span'
