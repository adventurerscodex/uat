...
class OtherStats(Component):
    ...
    ac_popover_content = Element(xpath='//*[@id="popover601427"]/div[2]')
    ...
    initiative_popover_content = Element(xpath='//*[@id="popover960064"]/div[2]')
    ...
    proficiency_popover_content = Element(xpath='//*[@id="popover276605"]/div[2]')
